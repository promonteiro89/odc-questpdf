...
/// <summary>
/// POSTs generated PDF bytes to a callback URL. Used by GenerateAndStore to keep
/// large documents off the 5.5 MB ODC inline-payload path: the bytes go straight
/// to your REST endpoint / pre-signed S3 URL and only a small status is returned.
/// </summary>
internal static class PdfDelivery
{
    // Single shared client. Timeout is kept under the ODC 95 s external-logic limit.
